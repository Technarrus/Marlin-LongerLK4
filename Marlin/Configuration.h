 ...
 *
 */
#define CONFIGURATION_H_VERSION 251020
...
#define STRING_CONFIG_H_AUTHOR "(Technarrus UNI 2.2)" // Who made the changes.
...
// Name displayed in the LCD "Ready" message and Info menu
 #define CUSTOM_MACHINE_NAME "UNI 3D Printer"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // на 260гр 
  //#define DEFAULT_Kp 15.07
  //#define DEFAULT_Ki 1.16
  //#define DEFAULT_Kd 48.90

  // на 240гр латунное сопло
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 70, 50, 70, 50 } // (mm) Left, Front, Right, Back insets
