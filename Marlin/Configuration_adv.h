 ...
 *
 */
#define CONFIGURATION_ADV_H_VERSION 25102020
...
#define LCD_SHOW_E_TOTAL
  ...
  #define BOOTSCREEN_TIMEOUT 400        // (ms) Total Duration to display the boot screen(s)
#endif
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_UNLOAD_PURGE_DELAY        70  // (ms) Delay for the filament to cool after retract.
